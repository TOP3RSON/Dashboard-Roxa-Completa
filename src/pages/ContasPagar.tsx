...
import { getContasAPagar, getCategorias, Categoria, Conta, deleteConta } from "@/integrations/supabase/queries";
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        ...
        description="Gerencie suas contas e compromissos financeiros"
      ...
      <NovaContaModal
        ...
        tipo={contaEditando?.tipo as 'a_pagar' || 'a_pagar'}
      />
      
      <Card>
        <CardHeader>
          <CardTitle>Lista de Contas a Pagar</CardTitle>
          <CardDescription>Acompanhe seus pagamentos pendentes</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
